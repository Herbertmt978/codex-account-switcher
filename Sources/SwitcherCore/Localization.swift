...
public enum L10n {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "account_context_unknown": "Account",
            "credits_balance": "Credits",
            "cached_balances": "Cached balances — awaiting refresh",
            "cached_balances_refresh_failed": "Cached balances — refresh failed",
            "usage_auth_rejected": "Codex rejected the saved sign-in. Sign in to this account in Codex Desktop, then choose Manage Accounts → Register Current Account to refresh its saved profile.",
            "target_sign_in_preflight_failed": "Codex could not verify the target's saved sign-in. The current account is unchanged and Codex remains open. Sign in to the target account, then choose Manage Accounts → Register Current Account.",
            "target_sign_in_unverified": "Codex could not verify the saved sign-in. The previous account was restored. Check the target account in Codex Desktop; if asked, sign in again, then choose Manage Accounts → Register Current Account.",
            "available_resets": "Available resets",
            "balance_unavailable": "Unavailable",
            "unlimited_credits": "Unlimited",
            "next_reset_expiry": "Next reset expiry",
            "next_known_reset_expiry": "Next known reset expiry",
            "resets_no_expiry": "Resets do not expire",
            "reset_expiry_unavailable": "Reset expiry unavailable",
            "weekly_usage_not_provided": "No weekly allowance provided for this account",
            ...
            "manual_update_hint": "Check for updates opens this fork's GitHub releases. Download and replace the app manually.",
            ...
            "sign_in_hint": "Sign in and choose Personal or your workspace in the browser. Add each separately, even when they share an email.",
            ...
            "active_unconfirmed": "Codex's current sign-in could not be matched safely. In Manage Accounts, choose Register Current Account before switching.",
        ...
        .simplifiedChinese: [
            "personal_account": "个人",
            "workspace_account": "工作区",
            "account_context_unknown": "账号",
            "credits_balance": "额度余额",
            "cached_balances": "已缓存余额，等待刷新",
            "cached_balances_refresh_failed": "已缓存余额，刷新失败",
            "usage_auth_rejected": "Codex 拒绝了已保存的登录信息。请先在 Codex Desktop 中登录此账号，然后选择“管理账号”→“注册当前账号”以更新保存的资料。",
            "target_sign_in_preflight_failed": "Codex 无法验证目标账号已保存的登录信息。当前账号未更改，Codex 保持打开。请登录目标账号，然后在“管理账号”中选择“注册当前账号”。",
            "target_sign_in_unverified": "Codex 无法验证已保存的登录信息。已恢复之前的账号。请在 Codex Desktop 中检查目标账号；如果提示登录，请重新登录，然后在“管理账号”中选择“注册当前账号”。",
            "available_resets": "可用重置次数",
            "balance_unavailable": "暂不可用",
            "unlimited_credits": "无限制",
            "next_reset_expiry": "下一次重置到期时间",
            "next_known_reset_expiry": "已知的下一次重置到期时间",
            "resets_no_expiry": "重置次数不会过期",
            "reset_expiry_unavailable": "重置到期时间暂不可用",
            "weekly_usage_not_provided": "此账号未提供每周额度",
            "settings_general": "通用",
            ...
            "manual_update_hint": "检查更新会打开此分支的 GitHub 发布页面，请手动下载并替换应用。",
            ...
            "english": "English",
            "simplified_chinese": "简体中文",
            "sign_in_hint": "在浏览器登录并选择个人账号或工作区。即使邮箱相同，也请分别添加。",
            ...
            "active_unconfirmed": "无法安全匹配 Codex 当前登录账号。切换前，请在“管理账号”中选择“注册当前账号”。",
