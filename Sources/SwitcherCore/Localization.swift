...
public enum L10n {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "credit_no_expiry": "No expiry",
            "reset_expiry_unavailable": "Reset expiry dates unavailable",
            "reset_expiry_partial": "Expiry dates shown for some available resets",
        ...
        .simplifiedChinese: [
            ...
            "credit_expires": "到期于",
            "credit_no_expiry": "无到期时间",
            "reset_expiry_unavailable": "重置到期时间暂不可用",
            "reset_expiry_partial": "仅显示部分可用重置的到期时间",
